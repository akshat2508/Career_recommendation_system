            ...
            <div class="relative flex justify-center xl:justify-end">
                ...
                <div class="relative z-10 w-full max-w-xl bg-white border-4 border-black rounded-[2rem] p-8 shadow-[12px_12px_0px_#000]">
                    ...
                    <form
                        ...
                        <label class="block">
                            ...
                            <div class="border-[3px] border-dashed border-black rounded-3xl bg-gray-50 p-12 text-center hover:bg-gray-100 transition-all duration-200 cursor-pointer">
                                ...
                                <div
                                    x-show="fileName"
                                    x-transition
                                    class="mt-6 bg-green-100 border-3 border-black rounded-2xl p-4 text-left">

                                    <p class="font-black text-sm uppercase tracking-widest">
                                        Resume Uploaded
                                    </p>

                                    <p
                                        class="mt-2 text-sm font-semibold break-all"
                                        x-text="fileName"></p>
                        ...
                        <button
                            :disabled="uploading"
                            class="w-full bg-black text-white border-4 border-black rounded-2xl py-5 text-xl font-black transition-all duration-200 shadow-[6px_6px_0px_#000]"
                            :class="uploading
        ? 'opacity-70 cursor-not-allowed'
        : 'hover:bg-white hover:text-black hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[3px_3px_0px_#000]'">
